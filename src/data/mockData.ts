...
export const mockEquipments: Equipment[] = [
  ...
  { id: '3', name: '打印机', code: 'EQ003', type: 'office', model: 'HP LaserJet Pro', manufacturer: '惠普', purchaseDate: '2022-11-10', price: 2300, location: '行政服务中心305室', departmentId: '5', responsiblePerson: '王五', status: 'maintenance', createdAt: '2022-11-10', updatedAt: '2024-01-10' },
  { id: '4', name: '投影仪', code: 'EQ004', type: 'office', model: 'EPSON CB-X06', manufacturer: '爱普生', purchaseDate: '2023-03-05', price: 3800, location: '财政大厦会议室', departmentId: '8', responsiblePerson: '赵六', status: 'idle', createdAt: '2023-03-05', updatedAt: '2023-03-05' },
];
...
export const mockSupplies: Supplies[] = [
  ...
  { id: '3', name: '办公椅', code: 'SP003', category: 'furniture', unit: '把', quantity: 20, unitPrice: 350, totalPrice: 7000, location: '仓库B区', departmentId: '5', purchaseDate: '2023-12-15', status: 'in-use', createdAt: '2023-12-15', updatedAt: '2023-12-15' },
  { id: '4', name: '消毒液', code: 'SP004', category: 'cleaning', unit: '瓶', quantity: 10, unitPrice: 25, totalPrice: 250, location: '仓库C区', departmentId: '8', purchaseDate: '2024-03-01', expirationDate: '2025-03-01', status: 'low-stock', createdAt: '2024-03-01', updatedAt: '2024-03-01' },
];